<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Grids.aspx.cs" Inherits="WebApplication3.Grids" enableEventValidation="false" %>
...
<body>
    ...
    <div>
        ...
        <div id="menu">
            <asp:LinkButton ID="ctrlSheet" OnClick="ctrlSheet_Click" runat="server" Text="Control Sheet"></asp:LinkButton>
            <asp:LinkButton ID="fastWax" OnClick="fastWax_Click" runat="server" Text="FW Report"></asp:LinkButton>
            <asp:LinkButton ID="fastWaxTotals" OnClick="fastWaxTotals_Click" runat="server" Text="FW Totals"></asp:LinkButton>
            <asp:LinkButton ID="changesBtn" OnClick="changesBtn_Click" runat="server" Text="Changes"></asp:LinkButton>
            <asp:LinkButton ID="krogerPeriods" OnClick="krogerPeriods_Click" runat="server" Text="Kroger Periods"></asp:LinkButton>
            <asp:LinkButton ID="exportAvg" OnClick="exportAvg_Click" runat="server" Text="Export Averages"></asp:LinkButton>
            <asp:LinkButton ID="WeeklyShow" OnClick="weeklyshow_Click" runat="server" Text="Weekly Show Total"></asp:LinkButton>
            <asp:LinkButton ID="FWBoundle" OnClick="FWBoundle_Click" runat="server" Text="FW Bundle Report"></asp:LinkButton>
            <asp:LinkButton ID="Returns" OnClick="Return_Click" runat="server" Text="Returns"></asp:LinkButton>
             <asp:LinkButton ID="DailySales" OnClick="DailySales_Click" runat="server" Text="Daily Sales"></asp:LinkButton>
