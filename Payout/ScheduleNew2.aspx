<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="ScheduleNew2.aspx.cs" Inherits="WebApplication3.ScheduleNew2" EnableEventValidation="false" %>
...
<ContentTemplate>
        ...
        <asp:GridView CssClass="neoGrid" ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1"
            HeaderStyle-Wrap="false" RowStyle-Wrap="false" DataKeyNames="Id" OnRowDataBound="GridView1_RowDataBound">
            <PagerStyle CssClass="neoPager" />
            <EmptyDataTemplate>
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Days" HeaderText="Days" SortExpression="Days" ReadOnly="True" />
                <asp:BoundField DataField="WeekEnding1" HeaderText="WeekEnding1" SortExpression="WeekEnding1" ReadOnly="True" />
                <asp:BoundField DataField="WeekEnding2" HeaderText="WeekEnding2" SortExpression="WeekEnding2" ReadOnly="True" />
                <asp:BoundField DataField="WeekEnding3" HeaderText="WeekEnding3" SortExpression="WeekEnding3" ReadOnly="True" />
