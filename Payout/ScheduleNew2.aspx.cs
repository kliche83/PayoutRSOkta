...
{
    public partial class ScheduleNew2 : System.Web.UI.Page
    {
        List<string> UsersRW;
            ...
            else
            {
                ...
                SQLString = string.Format(
                    @";WITH CTE AS(
                            ...
                            ORDER BY StartDate DESC, Program, StoreName, StoreNumber, ImportedBy, ImportedOn /*********************GET RID OF THIS ORDER BY************************/
                        )",
        ...
        protected void Page_LoadComplete(object sender, EventArgs e)
        {
            ...
            int numberOfRecords = 300,
                pagesToDisplay = 10; //how many page numbers are shown in the repater 

            string PageSize = "10";
            Common.PopulatePager(numberOfRecords, pageIndexvar, pagesToDisplay, PageSize, ref rptPager);
        }
        ...
        protected void addBtn_Click(object sender, EventArgs e)
        {
            ...
            //using (SqlConnection con = new SqlConnection(WebConfigurationManager.ConnectionStrings["ConnectionString"].ToString()))
            //{
            //string getId = "SELECT MAX(Id) FROM [PAYOUTschedule]";
            //con.Open();
            ...
            //    while (reader.Read())
            //    {
            //        Id = Convert.ToString(Convert.ToDecimal(reader[0].ToString()) + 1);
            //    }
            //}
            //con.Close();
            ...
            //updateR
            //con.Open();
            //using (SqlCommand cmd = new SqlCommand(updateR, con))
            //{
            //    SqlDataReader reader = cmd.ExecuteReader();
            //}
            //con.Close();
